...
ContentPage {
    ...
    ColumnLayout {
        ...
        ContentSection {
            ...
            title: Translation.tr("Visualizer 1")

            readonly property var entry: Config.options.background.widgets.visualizer
            readonly property bool bandStyle: ["bars", "mirror", "aurora", "dots"].includes(entry.style)
        ...
        ContentSection {
            id: settingsVisualizer2
            icon: "album"
            shape: MaterialShape.Shape.Burst
            title: Translation.tr("Visualizer 2")

            readonly property var entry: Config.options.background.widgets.visualizer2
            readonly property bool bandStyle: ["bars", "mirror", "aurora", "dots"].includes(entry.style)
            ...
            GroupedList {
                ConfigSwitch {
                    ...
                    buttonIcon: "check"
                    text: Translation.tr("Enable")
                    checked: settingsVisualizer2.entry.enable
                    onCheckedChanged: {
                        settingsVisualizer2.entry.enable = checked;
                    }
                }
            }
            ...
            ContentSubsection {
                ...
                ConfigSelectionArray {
                    currentValue: settingsVisualizer2.entry.style
                    onSelected: newValue => {
                        settingsVisualizer2.entry.style = newValue;
                    }
                    options: [
                        {
                            displayName: Translation.tr("Classic"),
            ...
            NoticeBox {
                Layout.fillWidth: true
                visible: settingsVisualizer2.entry.style === "ring"
                materialIcon: "touch_app"
                text: Translation.tr("Drag the ring on your desktop to move it, drag its corner to resize it")
            }
            ...
            ConfigSelectionArray {
                text: Translation.tr("Colors")
                icon: "palette"
                currentValue: settingsVisualizer2.entry.colorSource
                onSelected: newValue => {
                    settingsVisualizer2.entry.colorSource = newValue;
                }
                options: [
                    {
                        displayName: Translation.tr("Theme"),
            ...
            GroupedList {
                ConfigSlider {
                    ...
                    buttonIcon: "tune"
                    usePercentTooltip: false
                    value: settingsVisualizer2.entry.sensitivity * 100
                    from: 50
                    to: 300
                    stopIndicatorValues: [100]
                    onValueChanged: {
                        settingsVisualizer2.entry.sensitivity = Math.round(value) / 100;
                    }
                }
                ConfigSlider {
                    visible: settingsVisualizer2.bandStyle
                    text: Translation.tr("Height")
                    buttonIcon: "height"
                    usePercentTooltip: false
                    value: settingsVisualizer2.entry.height
                    from: 80
                    to: 600
                    stopIndicatorValues: [260]
                    onValueChanged: {
                        settingsVisualizer2.entry.height = Math.round(value);
                    }
                }
                ConfigSlider {
                    visible: settingsVisualizer2.entry.style === "ring"
                    ...
                    buttonIcon: "aspect_ratio"
                    usePercentTooltip: false
                    value: settingsVisualizer2.entry.ringSize
                    from: 150
                    to: 900
                    stopIndicatorValues: [380]
                    onValueChanged: {
                        settingsVisualizer2.entry.ringSize = Math.round(value);
                    }
                }
            }
        }
            ...
            GridLayout {
                ...
                Repeater {
                    model: [
                        ...
                        {
                            icon: "graphic_eq",
                            name: Translation.tr("Visualizer 1"),
                            enabled: Config.options.background.widgets.visualizer.enable
                        },
                        {
                            icon: "album",
                            name: Translation.tr("Visualizer 2"),
                            enabled: Config.options.background.widgets.visualizer2.enable
                        },
                        {
                            icon: "calendar_month",
                                ...
                                ConfigSwitch {
                                    ...
                                    onCheckedChanged: {
                                        if (modelData.icon === "weather_mix")
                                            ...
                                            Config.options.background.widgets.visualizer2.enable = checked
